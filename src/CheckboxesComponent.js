      ...
      <FormGroup check>
        <div className="double-consumer">
          <Label check className="input-label_mod">
            ...
            CONSUMER <span className="checkbox-counter">{this.props.numberOfAllUCforConsumer}</span>
          </Label>
        </div>
        <div className="double-pro">
          <Label check className="input-label_mod">
            ...
            PRO  <span className="checkbox-counter">{this.props.numberOfAllUCforPro}</span>
          </Label>
        </div>
      </FormGroup>
    )
